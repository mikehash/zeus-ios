...
//
// crate tree e90c369893fa5958a998d7b0d9f66763c909cd13 · dep pin 8e19318c · rustc 1.95.0 (59807616e 2026-04-14)
...
public struct TurnMessage {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(role: String, content: String, timestampRfc3339: String) {
        self.role = role
...
private var initializationResult: InitializationResult = {
    ...
    if (uniffi_zeus_core_bridge_checksum_method_zeuscore_messages() != 13192) {
        return InitializationResult.apiChecksumMismatch
    }
