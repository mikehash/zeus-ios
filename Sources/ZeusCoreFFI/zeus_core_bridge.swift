...
//
// crate tree 563be993638719facb1348004aa30a2d7ca2d8e4 · dep pin 8e19318c · rustc 1.95.0 (59807616e 2026-04-14)
...
open func search(query: String) -> [SearchHit] {
     ...
     * mutation could tell apart.
     */
open func send(sessionId: String, text: String, images: [ImageAttachment], sink: TokenSink)throws  {try rustCallWithError(FfiConverterTypeBridgeError.lift) {
    uniffi_zeus_core_bridge_fn_method_zeuscore_send(self.uniffiClonePointer(),
        FfiConverterString.lower(sessionId),
        FfiConverterString.lower(text),
        FfiConverterSequenceTypeImageAttachment.lower(images),
...
open func setProvider(id: String, model: String, key: String, baseUrl: String?)throws  {try rustCallWithError(FfiConverterTypeBridgeError.lift) {
     ...
     * disclosure, and `read_file` resolves relative paths against the root.
     */
open func stageAttachment(fileName: String, bytes: Data)throws  -> String {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeBridgeError.lift) {
    uniffi_zeus_core_bridge_fn_method_zeuscore_stage_attachment(self.uniffiClonePointer(),
...
extension ImageAttachment: Equatable, Hashable {
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeImageAttachment: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ImageAttachment {
        return
            try ImageAttachment(
    ...
    public static func write(_ value: ImageAttachment, into buf: inout [UInt8]) {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeImageAttachment_lift(_ buf: RustBuffer) throws -> ImageAttachment {
    return try FfiConverterTypeImageAttachment.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeImageAttachment_lower(_ value: ImageAttachment) -> RustBuffer {
    return FfiConverterTypeImageAttachment.lower(value)
}
...
public struct FfiConverterTypeAttachmentKind: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> AttachmentKind {
        ...
        case 1: return .image(mimeType: try FfiConverterString.read(from: &buf)
        )
        
        case 2: return .document(extension: try FfiConverterString.read(from: &buf)
        )
...
public struct FfiConverterTypeBridgeError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> BridgeError {
        ...
        case 5: return .EmptyAttachment
        case 6: return .NotAnImage(
            try FfiConverterString.read(from: &buf)
            )
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterSequenceTypeImageAttachment: FfiConverterRustBuffer {
    typealias SwiftType = [ImageAttachment]

    public static func write(_ value: [ImageAttachment], into buf: inout [UInt8]) {
        let len = Int32(value.count)
        writeInt(&buf, len)
        for item in value {
            FfiConverterTypeImageAttachment.write(item, into: &buf)
        }
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [ImageAttachment] {
        let len: Int32 = try readInt(&buf)
        var seq = [ImageAttachment]()
        seq.reserveCapacity(Int(len))
        for _ in 0 ..< len {
            seq.append(try FfiConverterTypeImageAttachment.read(from: &buf))
        }
        return seq
    }
}
 ...
 */
public func attachmentReference(relPath: String) -> String {
    return try!  FfiConverterString.lift(try! rustCall() {
    uniffi_zeus_core_bridge_fn_func_attachment_reference(
 ...
 * the wrong reason.
 */
public func classifyAttachment(fileName: String, mimeType: String?, bytes: Data) -> AttachmentKind {
    return try!  FfiConverterTypeAttachmentKind.lift(try! rustCall() {
    uniffi_zeus_core_bridge_fn_func_classify_attachment(
        FfiConverterString.lower(fileName),
...
private var initializationResult: InitializationResult = {
    ...
    if (uniffi_zeus_core_bridge_checksum_func_attachment_reference() != 63507) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_zeus_core_bridge_checksum_func_classify_attachment() != 47147) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_zeus_core_bridge_checksum_method_zeuscore_list_models() != 12757) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_zeus_core_bridge_checksum_method_zeuscore_send() != 59484) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_zeus_core_bridge_checksum_method_zeuscore_stage_attachment() != 40597) {
        return InitializationResult.apiChecksumMismatch
    }
